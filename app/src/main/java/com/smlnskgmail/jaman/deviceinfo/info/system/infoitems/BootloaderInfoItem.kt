...
class BootloaderInfoItem(private val context: Context, private val system: System) : InfoItem {

    override fun title() = "Bootloader"

    override fun body() = system.bootloader()
